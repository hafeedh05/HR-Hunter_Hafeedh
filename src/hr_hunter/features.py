...
TITLE_ROLE_SIGNAL_MAP = {
    ...
    "data_engineering": ["data engineer", "analytics engineer", "data platform", "etl", "pipeline"],
    "marketing": [
        "digital marketing",
        "growth marketing",
        "performance marketing",
    ...
    "mlops": ["mlops", "model serving", "machine learning operations", "ai platform"],
    ...
    "software_engineering": ["software engineer", "backend engineer", "full stack", "platform engineer"],
}
ADJACENT_TITLE_FAMILY_MAP = {
    "ai_engineering": {"data_engineering", "software_engineering", "mlops"},
    ...
    "data_engineering": {"ai_engineering", "software_engineering", "mlops"},
    "marketing": {"product_marketing", "shopper_marketing"},
    "mlops": {"ai_engineering", "data_engineering", "software_engineering"},
    ...
    "software_engineering": {"ai_engineering", "data_engineering", "mlops"},
